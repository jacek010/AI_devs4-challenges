...
from tools import http, hub, files, code, search, sleep, tokenizer, delegate, reset, grep, ask
...
_MODULES = [http, hub, files, code, search, sleep, tokenizer, delegate, reset, grep, ask]
